...
do
	...
	output_file="benchmark/"${NAME_MACHINE}"/"${NAME_MACHINE}"_gpu_"${num_gpu}"_bs_"${bs}"_real.txt"
	gpu_monitor_file="benchmark/"${NAME_MACHINE}"/"${NAME_MACHINE}"_gpu_"${num_gpu}"_bs_"${bs}"_real_monitor.csv"
	
	benchmark $bs $num_gpu "real" $output_file $gpu_monitor_file

	output_file="benchmark/"${NAME_MACHINE}"/"${NAME_MACHINE}"_gpu_"${num_gpu}"_bs_"${bs}"_syn.txt"
	gpu_monitor_file="benchmark/"${NAME_MACHINE}"/"${NAME_MACHINE}"_gpu_"${num_gpu}"_bs_"${bs}"_syn_monitor.csv"
